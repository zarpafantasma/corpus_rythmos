...
# ------------------------------------------
    ...
    event_explanations = {
        "NOVEMBER 2022 (FTX COLLAPSE)": """<div style="color: #A0AEC0; font-size: 0.95em;"><h4 style="color: #FFFFFF;">FTX SOLVENCY CRISIS (CHRONIC VISCOSITY)</h4><b>EMPIRICAL EVIDENCE:</b> Sustained "plateau" of viscosity. α holds between 1.10 and 1.25 for over 96 hours.<br><br><b>PHYSICAL STATE:</b> Evaporation of trust. Market behaved like a high-viscosity fluid; all movements required immense volume. <br><br><b>RTM reported 6 days of warning before the outage.</b></div>""",
