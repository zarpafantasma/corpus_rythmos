...
### S1: Neural Coherence & $\tau(L)$ Scaling Demonstration

**Purpose**: Validate that neural processes follow the RTM spatial-temporal scaling $\tau(L) \propto L^\alpha$, producing distinct topological signatures across frequency bands and states of consciousness.

**Methodological Upgrade**: 
- Following a rigorous audit, standard $1/e$ autocorrelation metrics were replaced with a robust **Fractal Power Spectral Density (PSD) Estimator** on signal amplitude envelopes. This accurately extracts Long-Range Temporal Correlations (LRTCs) without oscillatory artifacts.

**Key Findings**:
- **Frequency-Scale Hierarchy**: Slower rhythms necessitate higher topological coherence to maintain macro-scale
