...
def alpha_under_propofol(dose, alpha_baseline=2.44, alpha_min=1.50):
    """
...
def alpha_under_psychedelic(dose, alpha_baseline=2.44, alpha_peak=0.85):
    """
...
"""
    ...
    print("=" * 70)
    print("\nPropofol effects:")
    print(f"  α: 2.44 → 0.28 (collapse)")
    print(f"  NDI: 0.45 → 0.02 (collapse)")
    print("\nPsychedelic effects:")
    print(f"  α: 2.44 → 0.82 (increase)")
