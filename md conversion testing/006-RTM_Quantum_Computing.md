...
Each family produces a binwise $\hat{\alpha}_f$. Only families that pass collapse and QA contribute to the fused indicator
$$
\mathbb{E}_{C[\mathrm{QC}]} \mathbf{f}(t)
$$
(Section 6).
