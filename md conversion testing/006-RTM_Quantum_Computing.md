...
Each family produces a binwise $\hat{\alpha}_f$. Only families that pass collapse and QA contribute to the fused indicator $\mathbb{E}_{C[\mathrm{QC}]} \mathbf{f}(t)$ (Section 6).
...
| Family | #L pts | $\log L$ span | $\alpha_f$ (ODR, 50/95\% CI) | Theil–Sen | SIMEX band | ($R_{\text{coll}}^2$) | Leverage max | Flags |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
| Time/Arm | Families | $\alpha_{\text{QC}} \pm \text{SE}$ | (Q) (df) | $I^2$ | $\tau^2$ | Fusion? |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| RTM-aware | 3 | 0.69 $\pm$ 0.04 | 3.2 (2) | 37\% | 0.005 | Yes |
| Control | 3 | 0.54 $\pm$ 0.05 | 6.8 (2) | 71\% | 0.018 | No (report family-wise) |

### Table 3 — Protocol outcomes (A/B).

| Protocol | Metric | Control | RTM-aware | Effect ($\Delta$) | 95\% CI | Pass guardrail? |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| A (Phys) | $\alpha_{\text{phys}}$ | 0.48 | 0.64 | +0.16 | [0.07, 0.25] | ✔ |
...
-   **Fused slope:** ${\hat{\alpha}}_{\mathrm{QC}}=\sum w_f {\hat{\alpha}}_f / \sum w_f$; **variance:** $1 / \sum w_f$.
