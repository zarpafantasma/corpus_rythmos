...
-   Successful collapse when $\alpha^{\star} \in$`<!-- -->`{=html}95% CI of $\alpha_{bio,enz}$.
...
**Urease (replication):** $\alpha_{bio,enz} = \lbrack X.XX\rbrack\text{\:\,}(95\%\text{ }CI\text{\:}\text{\,}\lbrack X.XX,\text{ }X.XX\rbrack)$.
