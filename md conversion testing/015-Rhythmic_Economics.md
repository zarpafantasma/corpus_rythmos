...
$$(L_{u},T_{u})\ \ \ \ \text{with}\text{    }{\ L}_{u} > 0,\text{\:\,}T_{u} > 0.
$$
...
**3.2 Proxy families for** $\mathbf{L}\mathbf{\ }$**and** $\mathbf{T}$
...
**5.2 Feature construction: mapping to** $\mathbf{(}\mathbf{L}\mathbf{,}\mathbf{T}\mathbf{)}$
