...
$$\frac{T}{T_0}\ =\ \left(\ \frac{L}{L_0}\ \right)^\alpha\ \frac{\Theta\left(\mathcal{T}\right)}{\sqrt{\rho/\rho_0}},\quad \Theta\left(\mathcal{T}\right)\ \in\ \left\{\ \frac{\mathcal{T}}{\mathcal{T}_0},\ \sqrt{\frac{\mathcal{T}_s}{\mathcal{T}_l}}\ \right\}$$
