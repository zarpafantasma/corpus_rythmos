...
$$\frac{T}{T_{0}} = \left(\frac{L}{L_{0}}\right)^{\alpha} \frac{\Theta(\mathcal{T})}{\sqrt{\rho/\rho_{0}}}, \quad \Theta(\mathcal{T}) \in \left\{\frac{\mathcal{T}}{\mathcal{T}_{0}}, \sqrt{\frac{\mathcal{T}_{s}}{\mathcal{T}_{l}}}\right\}$$
