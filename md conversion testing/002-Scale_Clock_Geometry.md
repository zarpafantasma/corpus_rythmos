...
This section formalizes the scaling axiom behind RTM and derives the power-law form $T(L) = \kappa L^{\alpha}$. We also isolate the **clock** as a multiplicative gauge and prove that **slope** $\alpha$ is the structural invariant. Throughout, $L\in\mathbb R_0$ denotes a size/scale variable and $T(L)\in\mathbbR_(>0)$ a characteristic time.
