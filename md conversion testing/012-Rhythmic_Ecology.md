![](media/image1.jpeg){width="2.575in" height="2.575in"}
...
**4.4 SIMEX (optional; when** $\mathbf{Var}\mathbf{(}\mathbf{\xi}\mathbf{)}$ **is known/estimable)**
...
**6.6 Early-warning indicator:** $\mathbf{ECI}_{\mathbf{Eco}}\mathbf{(}\mathbf{t}\mathbf{)}$
...
**7. Fusion & the Ecosystem Coherence Index (**$\mathbf{ECI}_{\mathbf{Eco}}\mathbf{(}\mathbf{t}\mathbf{)}$**)**
...
With a 180-day EWMA baseline $\mu_{t \mid H} = 2.43,\text{ }\text{σ}_{\text{t}\text{∣}\text{H}}\text{\!}\text{=0.06}$, we get
...
**Caption template.**\
*Family-wise coherence exponents and fused estimate for \[BIN tags\].* Points: ${\widehat{\alpha}}_{f} \pm$`<!-- -->`{=html}95% CI; size $\propto w_{f} = 1/({\widehat{\sigma}}_{f}^{2} + {\widehat{\tau}}^{2})$. Diamond: ${\widehat{\alpha}}_{Eco}$(REML) if $I^{2} < 50\%$; otherwise "fusion suspended".
...
**9.3 Figure 3 ---**$\mathbf{ECI}_{\mathbf{Eco}}\mathbf{(}\mathbf{t}\mathbf{)}$ **time series**
...
**9.4 Table 1 --- BIN summary (machine-parsable)**
  ...
  -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  **BIN ID**   **Tags (biome/season/... )**                    **Family**   **#L**   **Span log L**   **Estimator**   $\widehat{\mathbf{\alpha}}$ **(95% CI)**   $$\mathbf{R}_{\mathbf{collapse}}^{\mathbf{2}}$$   **Decision**
  ------------ ----------------------------------------------- ------------ -------- ---------------- --------------- ------------------------------------------ ------------------------------------------------- --------------
...
**9.5 Table 2 --- Fusion and alerts**
  ...
  -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  **BIN ID**   **Families Fused**   **Q**   $$\mathbf{I}^{\mathbf{2}}$$   $${\widehat{\mathbf{\tau}}}^{\mathbf{2}}$$   ${\widehat{\mathbf{\alpha}}}_{\mathbf{Eco}}$***(SE)***   **Fusion Decision**   **Latest** $\mathbf{Z}_{\mathbf{t}}$   **Alert Tier**
  ------------ -------------------- ------- ----------------------------- -------------------------------------------- -------------------------------------------------------- --------------------- -------------------------------------- ----------------
...
-   Use **natural logs**; write $\log L,\text{ }\text{T}$ in math mode.
...
5.  Log-transform to $x = \log L,\text{ }\text{y=log T}$
